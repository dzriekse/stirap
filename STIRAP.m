...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
clear;
figure(1);      clf;        set(gcf,'Position',[50 100 1000 300]);
...
subplot(131),plot(t,o12,'r',t,o23,'b','LineWidth',1.2);
...
text(-70,1,'\fontsize{16}(a)')

subplot(132),plot(t,R1,'r',t,R2,'g',t,R3,'b','LineWidth',1.2);
set(gca,'xLim',[-1 1]*max(t),'TickLabelInterpreter','latex','FontSize',18,'LineWidth',1)
xlabel('$\Gamma_{12}t$','interpreter','latex','Color','k','FontSize',20);
...
subplot(133),plot(t,nt1,'r',t,nt2,'g',t,nt3,'b','LineWidth',1.2);
